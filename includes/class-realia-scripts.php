...
class Realia_Scripts {
	...
	public static function enqueue_frontend() {
		...
		wp_enqueue_script( 'slider', plugins_url( '/realia/assets/js/jquery.flexslider.js' ), array( 'jquery' ), false, true );

		wp_enqueue_script( 'realia', plugins_url( '/realia/assets/js/realia.js' ), array( 'jquery' ), false, true );
